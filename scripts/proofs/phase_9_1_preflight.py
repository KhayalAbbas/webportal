"""Phase 9.1 preflight: health, openapi, alembic head check, git snapshot."""
...
ARTIFACT = ROOT / "scripts" / "proofs" / "_artifacts" / "phase_9_1_preflight.txt"
OPENAPI_BEFORE = ROOT / "scripts" / "proofs" / "_artifacts" / "phase_9_1_openapi_before.json"
