...
PRE_FLIGHT = ART_DIR / "phase_9_8_preflight.txt"
OPENAPI_BEFORE = ART_DIR / "phase_9_8_openapi_before.json"
...
async def main() -> None:
    ...
    async with AsyncClient(transport=transport, base_url="http://testserver") as client:
        ...
        lines.append("GET /openapi.json (saved phase_9_8_openapi_before.json)")
