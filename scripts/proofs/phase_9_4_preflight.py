"""Phase 9.4 preflight: health, openapi, alembic head check, git snapshot."""
...
ARTIFACT = ROOT / "scripts" / "proofs" / "_artifacts" / "phase_9_4_preflight.txt"
OPENAPI_BEFORE = ROOT / "scripts" / "proofs" / "_artifacts" / "phase_9_4_openapi_before.json"
