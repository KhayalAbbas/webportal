"""Phase 9.3 preflight: health, openapi, alembic head check, git snapshot."""
...
ARTIFACT = ROOT / "scripts" / "proofs" / "_artifacts" / "phase_9_3_preflight.txt"
OPENAPI_BEFORE = ROOT / "scripts" / "proofs" / "_artifacts" / "phase_9_3_openapi_before.json"
